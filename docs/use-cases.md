...
| CU-03 | Listar estudiantes | `GET /api/students` | 200 `StudentDto[]` (global, sin datos sensibles extra) | — |
...
| CU-06 | Catálogo | `GET /api/programs|professors|courses` | 200 listas | — |
...
| CU-10 | Compañeros por materia | `GET /api/enrollments/courses/{courseId}/classmates` | 200 `[{studentId, fullName}]` solo nombres | 404 si materia no existe; `[]` si nadie inscrito |
